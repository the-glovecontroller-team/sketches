...
void SmoothAccel::updateData() {
    ...
    int16_t zPos = getDmpAccelerationZ();
...
int SmoothAccel::getAccelerationX() {
    int32_t sum = 0;
...
int SmoothAccel::getAccelerationY() {
    int32_t sum = 0;
...
int SmoothAccel::getDmpAccelerationX() {
    return mpu->getLinearAccelerationInWorldX() / 100;
}

int SmoothAccel::getDmpAccelerationY() {
    return mpu->getLinearAccelerationInWorldY() / 100;
}

int SmoothAccel::getDmpAccelerationZ() {
